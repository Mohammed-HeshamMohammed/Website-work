  ...
  return (
    <section ref={containerRef} className="relative py-32 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          <motion.div className="text-base font-medium inline-block mb-3 px-4 py-1 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20">
            OUR AUDIENCE
          </motion.div>
          <h2 className="text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-purple-700 to-pink-600">
          ...
          {customers.map((customer, index) => {
            ...
            return (
              <motion.div
                ...
                className="flex flex-col gap-16 items-center relative"
              ...
              >
                ...
                <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-16 items-center w-full`}>
                  {/* IMAGE CONTAINER */}
                  <div className="flex-1 w-full">
                    ...
                    >
                      ...
                      >
                        ...
                        {/* Floating badge */}
                        <motion.div
                          className="absolute top-6 left-6 bg-white/10 backdrop-blur-md px-4 py-2 rounded-lg shadow-lg z-10 flex items-center gap-2"
                      ...
                      {/* Icon circle - positioned outside the card */}
                      <div className={cn(
                        "absolute w-32 h-32 rounded-full border-8 border-gray-100 bg-white/80 backdrop-blur-sm z-10 flex items-center justify-center text-3xl",
                        isEven ? "right-0" : "left-0",
                        "translate-x-1/2 translate-y-1/2 bottom-0",
                        customer.color === "blue" && "text-blue-600",
                        customer.color === "pink" && "text-pink-600",
                        customer.color === "purple" && "text-purple-700"
                      )}>
                  ...
                  <div className="flex-1 space-y-8">
                    ...
                    >
                      ...
                      <span className="text-sm font-medium uppercase tracking-wider text-gray-500">Customer Segment {index + 1}</span>
                    </motion.div>
                    ...
                    >
                      <Link href="/plans">
                        <Button 
                          className={cn(
                            "rounded-full px-8 py-6 text-white shadow-lg flex items-center gap-2 group",
