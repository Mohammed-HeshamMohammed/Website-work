      ...
      <div className="container max-w-4xl px-4 md:px-8">
        <div className="mb-8 md:mb-12">
          ...
          <motion.h1
            ...
            className="text-3xl md:text-4xl font-bold text-[#03045e] mb-2 md:mb-4"
          >
            Terms of Service
          </motion.h1>
          <motion.p
        ...
        <div className="space-y-6 md:space-y-8">
          {sections.map((section, index) => (
            ...
            >
              <Card className="p-4 md:p-6 bg-white border border-[#caf0f8] hover:border-[#90e0ef] transition-colors">
                <h2 className="text-xl md:text-2xl font-bold text-[#03045e] mb-3 md:mb-4">{section.title}</h2>
                {section.content.map((contentBlock, blockIndex) => (
                  <div key={blockIndex} className="mb-3 last:mb-0 text-sm md:text-base">
                    {contentBlock.text && (
                        ...
                        {contentBlock.items.map((item: string, itemIndex: number) => (
                          <li
                            ...
                            className={`text-gray-600 ${
                              item.startsWith("-") ? "ml-6 md:ml-8" : "ml-2 md:ml-4"
                            }`}
                          >
                            {item}
                          </li>
