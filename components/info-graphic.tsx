  ...
  const steps = [
    {
      ...
      description: "Find potential properties that match your investment criteria",
    },
    {
      icon: Database,
      title: "Skip Trace Data",
      description: "Get accurate contact information for property owners",
    },
    {
      icon: Phone,
      title: "Connect",
      description: "Reach out to property owners directly",
    },
  ]
